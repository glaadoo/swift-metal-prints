...
const StepSize = ({ imageUrl, sizeIdx, customWidth, customHeight, quantity, material, additionalPrints, imageNaturalWidth, imageNaturalHeight, rotation, zoom, panX, panY, onSelect, onCustomSize, onQuantity, onAdditionalPrints, onSelectMaterial, onRotate, onZoom, onPan, onUpload, onNext, onBack }: Props) => {
  ...
  /** Build CSS transform with rotation compensation so rotated images don't overflow */
    ...
    <div className="space-y-4">
      <div className="text-center">
        <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground">
          {hasImage ? "Choose Your Size" : "Upload Your Photo"}
        </h2>
        <p className="text-muted-foreground font-body mt-1 tracking-wide text-sm">
          {hasImage ? "Drag to reposition your image within the frame." : "JPG, PNG, TIFF"}
        </p>
      </div>
      ...
      <div className="flex justify-between pt-4">
        ...
        <Button onClick={onNext} disabled={!hasImage} className="bg-gradient-gold text-primary-foreground font-body font-semibold hover:opacity-90 gap-2">
